...
WebUI.sendKeys(findTestObject('Page_NPS Auctions/Page_NPS Auctions/input_Email address_email'), 'abdul.auctionsoftware+nps01@gmail.com')

WebUI.sendKeys(findTestObject('Page_NPS Auctions/Page_NPS Auctions/input_Password_password'), 'Test@12345')

WebUI.click(findTestObject('Page_NPS Auctions/button_Login'))
